...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.Category();
  });
  ...
  describe('Category', function() {
    it('should create an instance of Category', function() {
      ...
      //var instane = new FacestoreApi.Category();
      //expect(instance).to.be.a(FacestoreApi.Category);
    });
    ...
    it('should have the property imageSmall (base name: "image_small")', function() {
      // uncomment below and update the code to test the property imageSmall
      //var instane = new FacestoreApi.Category();
      //expect(instance).to.be();
    });

    it('should have the property imageLarger (base name: "image_larger")', function() {
      // uncomment below and update the code to test the property imageLarger
      //var instane = new FacestoreApi.Category();
      //expect(instance).to.be();
    });
