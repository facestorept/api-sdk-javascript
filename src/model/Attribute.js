...
export default class Attribute {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_searchable')) {
                obj['is_searchable'] = ApiClient.convertToType(data['is_searchable'], 'Boolean');
            }
            if (data.hasOwnProperty('active')) {
                obj['active'] = ApiClient.convertToType(data['active'], 'Boolean');
            }
            if (data.hasOwnProperty('options')) {
                obj['options'] = AttributeOptions.constructFromObject(data['options']);
            }
            if (data.hasOwnProperty('i18n')) {
                obj['i18n'] = I18n.constructFromObject(data['i18n']);
            }
    ...
    */
    active = undefined;
    /**
    * @member {module:model/AttributeOptions} options
    */
    options = undefined;
    /**
    * @member {module:model/I18n} i18n
    */
    i18n = undefined;
    /**
