...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.I18nProduct();
  });
  ...
  describe('I18nProduct', function() {
    it('should create an instance of I18nProduct', function() {
      // uncomment below and update the code to test I18nProduct
      //var instane = new FacestoreApi.I18nProduct();
      //expect(instance).to.be.a(FacestoreApi.I18nProduct);
    });
    ...
    it('should have the property characteristics (base name: "characteristics")', function() {
      // uncomment below and update the code to test the property characteristics
      //var instane = new FacestoreApi.I18nProduct();
      //expect(instance).to.be();
    });
