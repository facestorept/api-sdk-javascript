...
export default class Customer {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('birhday')) {
                obj['birhday'] = ApiClient.convertToType(data['birhday'], 'Date');
            }
            ...
            if (data.hasOwnProperty('received_newsletter')) {
                obj['received_newsletter'] = ApiClient.convertToType(data['received_newsletter'], 'Boolean');
            }
    ...
    */
    gender = undefined;
    /**
    * @member {Boolean} received_newsletter
    */
    received_newsletter = undefined;
    /**
