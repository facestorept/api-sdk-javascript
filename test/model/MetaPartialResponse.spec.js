...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.MetaPartialResponse();
  });
  ...
  describe('MetaPartialResponse', function() {
    it('should create an instance of MetaPartialResponse', function() {
      // uncomment below and update the code to test MetaPartialResponse
      //var instane = new FacestoreApi.MetaPartialResponse();
      //expect(instance).to.be.a(FacestoreApi.MetaPartialResponse);
    });
