...
export default class Category {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('image_small')) {
                obj['image_small'] = ApiClient.convertToType(data['image_small'], 'String');
            }
            if (data.hasOwnProperty('image_larger')) {
                obj['image_larger'] = ApiClient.convertToType(data['image_larger'], 'String');
            }
            ...
            if (data.hasOwnProperty('i18n')) {
                obj['i18n'] = ApiClient.convertToType(data['i18n'], [I18n]);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * The file to be attached. Must be multipart/form-data. The maximum file size is 2 MB. 
    * @member {String} image_larger
    */
    image_larger = undefined;
    /**
    ...
    * @member {Array.<module:model/Category.VisibilityEnum>} visibility
    */
    visibility = undefined;
    /**
    * I18n fields to categories
    * @member {Array.<module:model/I18n>} i18n
    */
    i18n = undefined;
