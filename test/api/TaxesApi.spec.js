...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.TaxesApi();
  });
  ...
  describe('TaxesApi', function() {
    describe('addTaxes', function() {
      it('should call addTaxes successfully', function(done) {
        //uncomment below and update the code to test addTaxes
        //instance.addTaxes(function(error) {
    ...
    describe('deleteTaxById', function() {
      it('should call deleteTaxById successfully', function(done) {
        //uncomment below and update the code to test deleteTaxById
        //instance.deleteTaxById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTaxById', function() {
      it('should call getTaxById successfully', function(done) {
        //uncomment below and update the code to test getTaxById
        //instance.getTaxById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateTaxById', function() {
      it('should call updateTaxById successfully', function(done) {
        //uncomment below and update the code to test updateTaxById
        //instance.updateTaxById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateTaxById_0', function() {
      it('should call updateTaxById_0 successfully', function(done) {
        //uncomment below and update the code to test updateTaxById_0
        //instance.updateTaxById_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
