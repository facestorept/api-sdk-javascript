...
export default class ProductsAttributesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addProductsAttributes operation.
     * @callback module:api/ProductsAttributesApi~addProductsAttributesCallback
     ...
     * @param {module:model/Attribute} attribute Attribute to add to the store
     * @param {module:api/ProductsAttributesApi~addProductsAttributesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Attribute>}
     */
    addProductsAttributes(attribute, callback) {
      let postBody = attribute;

      // verify the required parameter 'attribute' is set
      if (attribute === undefined || attribute === null) {
        throw new Error("Missing the required parameter 'attribute' when calling addProductsAttributes");
      }
    ...
    /**
     * Callback function to receive the result of the deleteProductAttributeById operation.
     * @callback module:api/ProductsAttributesApi~deleteProductAttributeByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id ID of attribute to delete
     * @param {module:api/ProductsAttributesApi~deleteProductAttributeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteProductAttributeById(id, callback) {
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteProductAttributeById");
      }
    ...
    /**
     * Callback function to receive the result of the getProductAttributeById operation.
     * @callback module:api/ProductsAttributesApi~getProductAttributeByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id ID of attribute to fetch
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.includes Include associated objects within response
     * @param {module:api/ProductsAttributesApi~getProductAttributeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Attribute}
     */
    getProductAttributeById(id, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getProductAttributeById");
      }
    ...
    /**
     * Callback function to receive the result of the getProductsAttributes operation.
     * @callback module:api/ProductsAttributesApi~getProductsAttributesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Attribute>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ProductsAttributesApi~getProductsAttributesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Attribute>}
     */
    getProductsAttributes(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateProductAttributeById operation.
     * @callback module:api/ProductsAttributesApi~updateProductAttributeByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Attribute} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of attribute to update
     * @param {module:model/Attribute} productAttribute Attribute to add to the store
     * @param {module:api/ProductsAttributesApi~updateProductAttributeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Attribute}
     */
    updateProductAttributeById(id, productAttribute, callback) {
      let postBody = productAttribute;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateProductAttributeById");
      }

      // verify the required parameter 'productAttribute' is set
      if (productAttribute === undefined || productAttribute === null) {
        throw new Error("Missing the required parameter 'productAttribute' when calling updateProductAttributeById");
      }
