...
export default class TaxesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addTaxes operation.
     * @callback module:api/TaxesApi~addTaxesCallback
     ...
     * @param {module:model/Tax} tax Tax to add to the store
     * @param {module:api/TaxesApi~addTaxesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    addTaxes(tax, callback) {
      let postBody = tax;

      // verify the required parameter 'tax' is set
      if (tax === undefined || tax === null) {
        throw new Error("Missing the required parameter 'tax' when calling addTaxes");
      }
    ...
    /**
     * Callback function to receive the result of the deleteTaxById operation.
     * @callback module:api/TaxesApi~deleteTaxByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id ID of tax to delete
     * @param {module:api/TaxesApi~deleteTaxByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteTaxById(id, callback) {
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteTaxById");
      }
    ...
    /**
     * Callback function to receive the result of the getTaxById operation.
     * @callback module:api/TaxesApi~getTaxByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of tax to fetch
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit max records to return
     * @param {module:api/TaxesApi~getTaxByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    getTaxById(id, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTaxById");
      }
    ...
    /**
     * Callback function to receive the result of the updateTaxById operation.
     * @callback module:api/TaxesApi~updateTaxByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of tax to update
     * @param {module:model/Tax} tax Tax to add to the store
     * @param {module:api/TaxesApi~updateTaxByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    updateTaxById(id, tax, callback) {
      let postBody = tax;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateTaxById");
      }

      // verify the required parameter 'tax' is set
      if (tax === undefined || tax === null) {
        throw new Error("Missing the required parameter 'tax' when calling updateTaxById");
      }
    ...
    /**
     * Callback function to receive the result of the updateTaxById_0 operation.
     * @callback module:api/TaxesApi~updateTaxById_0Callback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of tax to update
     * @param {module:model/Tax} tax Tax to add to the store
     * @param {module:api/TaxesApi~updateTaxById_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    updateTaxById_0(id, tax, callback) {
      let postBody = tax;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateTaxById_0");
      }

      // verify the required parameter 'tax' is set
      if (tax === undefined || tax === null) {
        throw new Error("Missing the required parameter 'tax' when calling updateTaxById_0");
      }
