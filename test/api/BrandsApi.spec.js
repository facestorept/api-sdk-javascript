...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.BrandsApi();
  });
  ...
  describe('BrandsApi', function() {
    describe('addBrands', function() {
      it('should call addBrands successfully', function(done) {
        //uncomment below and update the code to test addBrands
        //instance.addBrands(function(error) {
    ...
    describe('deleteBrandById', function() {
      it('should call deleteBrandById successfully', function(done) {
        //uncomment below and update the code to test deleteBrandById
        //instance.deleteBrandById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getBrandById', function() {
      it('should call getBrandById successfully', function(done) {
        //uncomment below and update the code to test getBrandById
        //instance.getBrandById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateCategoryById_0', function() {
      it('should call updateCategoryById_0 successfully', function(done) {
        //uncomment below and update the code to test updateCategoryById_0
        //instance.updateCategoryById_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
