...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.PaymentsApi();
  });
  ...
  describe('PaymentsApi', function() {
    describe('getPaymentById', function() {
      it('should call getPaymentById successfully', function(done) {
        //uncomment below and update the code to test getPaymentById
        //instance.getPaymentById(function(error) {
