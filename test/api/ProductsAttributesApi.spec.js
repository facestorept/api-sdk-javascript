...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.ProductsAttributesApi();
  });
  ...
  describe('ProductsAttributesApi', function() {
    describe('addProductsAttributes', function() {
      it('should call addProductsAttributes successfully', function(done) {
        //uncomment below and update the code to test addProductsAttributes
        //instance.addProductsAttributes(function(error) {
    ...
    describe('deleteProductAttributeById', function() {
      it('should call deleteProductAttributeById successfully', function(done) {
        //uncomment below and update the code to test deleteProductAttributeById
        //instance.deleteProductAttributeById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getProductAttributeById', function() {
      it('should call getProductAttributeById successfully', function(done) {
        //uncomment below and update the code to test getProductAttributeById
        //instance.getProductAttributeById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getProductsAttributes', function() {
      it('should call getProductsAttributes successfully', function(done) {
        //uncomment below and update the code to test getProductsAttributes
        //instance.getProductsAttributes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateProductAttributeById', function() {
      it('should call updateProductAttributeById successfully', function(done) {
        //uncomment below and update the code to test updateProductAttributeById
        //instance.updateProductAttributeById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
