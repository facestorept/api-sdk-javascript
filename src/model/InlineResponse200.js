...
import MetaPartialResponse from './MetaPartialResponse';
...
export default class InlineResponse200 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = MetaPartialResponse.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    */
    data = undefined;
    /**
    * @member {module:model/MetaPartialResponse} meta
    */
    meta = undefined;
