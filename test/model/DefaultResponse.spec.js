...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.DefaultResponse();
  });
  ...
  describe('DefaultResponse', function() {
    it('should create an instance of DefaultResponse', function() {
      // uncomment below and update the code to test DefaultResponse
      //var instane = new FacestoreApi.DefaultResponse();
      //expect(instance).to.be.a(FacestoreApi.DefaultResponse);
    });
