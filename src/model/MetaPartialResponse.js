...
/**
* The MetaPartialResponse model module.
* @module model/MetaPartialResponse
* @version 0.1.4
*/
export default class MetaPartialResponse {
    /**
    * Constructs a new <code>MetaPartialResponse</code>.
    * @alias module:model/MetaPartialResponse
    * @class
    */
    ...
    /**
    * Constructs a <code>MetaPartialResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetaPartialResponse} obj Optional instance to populate.
    * @return {module:model/MetaPartialResponse} The populated <code>MetaPartialResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetaPartialResponse();
