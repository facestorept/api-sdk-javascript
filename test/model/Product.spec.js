...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instane = new FacestoreApi.Product();
      //expect(instance).to.be.a(FacestoreApi.Product);
    });
    ...
    it('should have the property urlVideo (base name: "url_video")', function() {
      // uncomment below and update the code to test the property urlVideo
      //var instane = new FacestoreApi.Product();
      //expect(instance).to.be();
    });
    ...
    it('should have the property inHomepage (base name: "in_homepage")', function() {
      // uncomment below and update the code to test the property inHomepage
      //var instane = new FacestoreApi.Product();
      //expect(instance).to.be();
    });

    it('should have the property isPrefered (base name: "is_prefered")', function() {
      // uncomment below and update the code to test the property isPrefered
      //var instane = new FacestoreApi.Product();
      //expect(instance).to.be();
    });
    ...
    it('should have the property urlDigital (base name: "url_digital")', function() {
      // uncomment below and update the code to test the property urlDigital
      //var instane = new FacestoreApi.Product();
      //expect(instance).to.be();
    });
