...
import I18nProduct from './I18nProduct';
...
export default class Product {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('manual')) {
                obj['manual'] = ApiClient.convertToType(data['manual'], 'String');
            }
            if (data.hasOwnProperty('url_video')) {
                obj['url_video'] = ApiClient.convertToType(data['url_video'], 'String');
            }
            if (data.hasOwnProperty('visibility')) {
                obj['visibility'] = ApiClient.convertToType(data['visibility'], ['String']);
            }
            if (data.hasOwnProperty('in_homepage')) {
                obj['in_homepage'] = ApiClient.convertToType(data['in_homepage'], 'Boolean');
            }
            if (data.hasOwnProperty('is_prefered')) {
                obj['is_prefered'] = ApiClient.convertToType(data['is_prefered'], 'Boolean');
            }
            if (data.hasOwnProperty('is_digital')) {
                obj['is_digital'] = ApiClient.convertToType(data['is_digital'], 'Boolean');
            }
            if (data.hasOwnProperty('url_digital')) {
                obj['url_digital'] = ApiClient.convertToType(data['url_digital'], 'String');
            }
            if (data.hasOwnProperty('is_new')) {
                obj['is_new'] = ApiClient.convertToType(data['is_new'], 'Boolean');
            }
            if (data.hasOwnProperty('i18n')) {
                obj['i18n'] = I18nProduct.constructFromObject(data['i18n']);
            }
    ...
    */
    manual = undefined;
    /**
    * @member {String} url_video
    */
    url_video = undefined;
    /**
    * channels that resource are showed
    * @member {Array.<module:model/Product.VisibilityEnum>} visibility
    */
    visibility = undefined;
    /**
    * @member {Boolean} in_homepage
    */
    in_homepage = undefined;
    /**
    * @member {Boolean} is_prefered
    */
    ...
    */
    ...
    /**
    * @member {String} url_digital
    */
    url_digital = undefined;
    /**
    * @member {Boolean} is_new
    */
    is_new = undefined;
    /**
    * @member {module:model/I18nProduct} i18n
    */
    i18n = undefined;
    /**
