...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.Options();
  });
  ...
  describe('Options', function() {
    it('should create an instance of Options', function() {
      ...
      //var instane = new FacestoreApi.Options();
      //expect(instance).to.be.a(FacestoreApi.Options);
    });
    ...
    it('should have the property auxCode (base name: "aux_code")', function() {
      // uncomment below and update the code to test the property auxCode
      //var instane = new FacestoreApi.Options();
      //expect(instance).to.be();
    });
