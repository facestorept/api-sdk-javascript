...
/**
* The I18nProductSeo model module.
* @module model/I18nProductSeo
* @version 0.1.4
*/
export default class I18nProductSeo {
    /**
    * Constructs a new <code>I18nProductSeo</code>.
    * @alias module:model/I18nProductSeo
    * @class
    */
    ...
    /**
    * Constructs a <code>I18nProductSeo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/I18nProductSeo} obj Optional instance to populate.
    * @return {module:model/I18nProductSeo} The populated <code>I18nProductSeo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new I18nProductSeo();
