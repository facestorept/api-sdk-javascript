...
export default class BrandsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addBrands operation.
     * @callback module:api/BrandsApi~addBrandsCallback
     ...
     * @param {module:model/Brand} brand Brand to add to the store
     * @param {module:api/BrandsApi~addBrandsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse201}
     */
    addBrands(brand, callback) {
      let postBody = brand;

      // verify the required parameter 'brand' is set
      if (brand === undefined || brand === null) {
        throw new Error("Missing the required parameter 'brand' when calling addBrands");
      }
     ...
     * @callback module:api/BrandsApi~updateCategoryByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of brand to update
     * @param {Object} brand Brand to update in store
     * @param {module:api/BrandsApi~updateCategoryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateCategoryById(id, brand, callback) {
      let postBody = brand;
      ...
      // verify the required parameter 'brand' is set
      if (brand === undefined || brand === null) {
        throw new Error("Missing the required parameter 'brand' when calling updateCategoryById");
      }
    ...
    /**
     * Callback function to receive the result of the updateCategoryById_0 operation.
     * @callback module:api/BrandsApi~updateCategoryById_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of brand to update
     * @param {Object} brand Brand to update in store
     * @param {module:api/BrandsApi~updateCategoryById_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    updateCategoryById_0(id, brand, callback) {
      let postBody = brand;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateCategoryById_0");
      }

      // verify the required parameter 'brand' is set
      if (brand === undefined || brand === null) {
        throw new Error("Missing the required parameter 'brand' when calling updateCategoryById_0");
      }
