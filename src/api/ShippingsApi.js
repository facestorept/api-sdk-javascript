...
/**
* Shippings service.
* @module api/ShippingsApi
* @version 0.1.4
*/
export default class ShippingsApi {

    /**
    * Constructs a new ShippingsApi. 
    * @alias module:api/ShippingsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addShipping operation.
     * @callback module:api/ShippingsApi~addShippingCallback
     ...
     * @param {module:model/Shipping} shipping Shipping to add to the store
     * @param {module:api/ShippingsApi~addShippingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    addShipping(shipping, callback) {
      let postBody = shipping;

      // verify the required parameter 'shipping' is set
      if (shipping === undefined || shipping === null) {
        throw new Error("Missing the required parameter 'shipping' when calling addShipping");
      }
    ...
    /**
     * Callback function to receive the result of the deleteShippingById operation.
     * @callback module:api/ShippingsApi~deleteShippingByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} id ID of shipping to delete
     * @param {module:api/ShippingsApi~deleteShippingByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteShippingById(id, callback) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteShippingById");
      }
    ...
    /**
     * Callback function to receive the result of the getShippingById operation.
     * @callback module:api/ShippingsApi~getShippingByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2013} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of shipping to fetch
     * @param {Object} opts Optional parameters
     * @param {Number} opts.limit max records to return
     * @param {module:api/ShippingsApi~getShippingByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    getShippingById(id, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getShippingById");
      }
    ...
    /**
     * Callback function to receive the result of the getShippings operation.
     * @callback module:api/ShippingsApi~getShippingsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ShippingsApi~getShippingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2003}
     */
    getShippings(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateShippingById operation.
     * @callback module:api/ShippingsApi~updateShippingByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2013} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of shipping to update
     * @param {module:model/Shipping} tax Shipping to update in store
     * @param {module:api/ShippingsApi~updateShippingByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    updateShippingById(id, tax, callback) {
      let postBody = tax;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateShippingById");
      }

      // verify the required parameter 'tax' is set
      if (tax === undefined || tax === null) {
        throw new Error("Missing the required parameter 'tax' when calling updateShippingById");
      }
    ...
    /**
     * Callback function to receive the result of the updateShippingById_0 operation.
     * @callback module:api/ShippingsApi~updateShippingById_0Callback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2013} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id ID of shipping to update
     * @param {module:model/Shipping} tax Shipping to update in store
     * @param {module:api/ShippingsApi~updateShippingById_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    updateShippingById_0(id, tax, callback) {
      let postBody = tax;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateShippingById_0");
      }

      // verify the required parameter 'tax' is set
      if (tax === undefined || tax === null) {
        throw new Error("Missing the required parameter 'tax' when calling updateShippingById_0");
      }
