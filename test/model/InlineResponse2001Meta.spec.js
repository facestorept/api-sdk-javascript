...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.InlineResponse2001Meta();
  });
  ...
  describe('InlineResponse2001Meta', function() {
    it('should create an instance of InlineResponse2001Meta', function() {
      // uncomment below and update the code to test InlineResponse2001Meta
      //var instane = new FacestoreApi.InlineResponse2001Meta();
      //expect(instance).to.be.a(FacestoreApi.InlineResponse2001Meta);
    });
