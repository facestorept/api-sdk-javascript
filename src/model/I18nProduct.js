...
import I18nProductSeo from './I18nProductSeo';
...
/**
* The I18nProduct model module.
* @module model/I18nProduct
* @version 0.1.4
*/
export default class I18nProduct {
    /**
    * Constructs a new <code>I18nProduct</code>.
    * @alias module:model/I18nProduct
    * @class
    * @param locale {String} 
    * @param name {String} 
    */
    ...
    /**
    * Constructs a <code>I18nProduct</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/I18nProduct} obj Optional instance to populate.
    * @return {module:model/I18nProduct} The populated <code>I18nProduct</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new I18nProduct();
            ...
            if (data.hasOwnProperty('characteristics')) {
                obj['characteristics'] = ApiClient.convertToType(data['characteristics'], 'String');
            }
            if (data.hasOwnProperty('seo')) {
                obj['seo'] = I18nProductSeo.constructFromObject(data['seo']);
            }
        }
        return obj;
    }
    ...
    */
    ...
    /**
    * @member {String} characteristics
    */
    characteristics = undefined;
    /**
    * @member {module:model/I18nProductSeo} seo
    */
    seo = undefined;
