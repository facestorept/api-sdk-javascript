...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.ShippingsApi();
  });
  ...
  describe('ShippingsApi', function() {
    describe('addShipping', function() {
      it('should call addShipping successfully', function(done) {
        //uncomment below and update the code to test addShipping
        //instance.addShipping(function(error) {
    ...
    describe('deleteShippingById', function() {
      it('should call deleteShippingById successfully', function(done) {
        //uncomment below and update the code to test deleteShippingById
        //instance.deleteShippingById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShippingById', function() {
      it('should call getShippingById successfully', function(done) {
        //uncomment below and update the code to test getShippingById
        //instance.getShippingById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShippings', function() {
      it('should call getShippings successfully', function(done) {
        //uncomment below and update the code to test getShippings
        //instance.getShippings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateShippingById', function() {
      it('should call updateShippingById successfully', function(done) {
        //uncomment below and update the code to test updateShippingById
        //instance.updateShippingById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateShippingById_0', function() {
      it('should call updateShippingById_0 successfully', function(done) {
        //uncomment below and update the code to test updateShippingById_0
        //instance.updateShippingById_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
