...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.ProductsApi();
  });
  ...
  describe('ProductsApi', function() {
    ...
    describe('updateProductById_0', function() {
      it('should call updateProductById_0 successfully', function(done) {
        //uncomment below and update the code to test updateProductById_0
        //instance.updateProductById_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
