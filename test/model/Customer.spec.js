...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FacestoreApi.Customer();
  });
  ...
  describe('Customer', function() {
    it('should create an instance of Customer', function() {
      ...
      //var instane = new FacestoreApi.Customer();
      //expect(instance).to.be.a(FacestoreApi.Customer);
    });
    ...
    it('should have the property birhday (base name: "birhday")', function() {
      // uncomment below and update the code to test the property birhday
      //var instane = new FacestoreApi.Customer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property receivedNewsletter (base name: "received_newsletter")', function() {
      // uncomment below and update the code to test the property receivedNewsletter
      //var instane = new FacestoreApi.Customer();
      //expect(instance).to.be();
    });
